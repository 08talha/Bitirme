package com.example.talha.bitirme;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final float TIMEDIFF_FACTOR_Z = 500f; // More sensitive on z-axis
     ...
     String SERVER_IP = "172.26.1.1"; // Server receiving signals from phone

    private Handler mHandler;
    private Button mBtnDrive,ipDegistir;
    ...
    private EditText ipp,porrt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        ipp=(EditText)findViewById(R.id.IPport);

        porrt=(EditText)findViewById(R.id.portIP);
        ipDegistir=(Button)findViewById(R.id.button);
        ...
        ipDegistir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SERVERPORT = Integer.parseInt(porrt.getText().toString());
                SERVER_IP = ipp.getText().toString();
            }
        });
     ...
     */
    class BtnDriveOnTouchListener implements View.OnTouchListener {
